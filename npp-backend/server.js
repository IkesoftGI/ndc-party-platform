...
app.get("/health", (_req, res) => {
  res.json({ ok: true, service: "npp-backend", version: "0.1", time: new Date().toISOString() });
});
...
app.listen(PORT, () => console.log(`🚀 npp-backend running on http://localhost:${PORT}`));
