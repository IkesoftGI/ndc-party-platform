// src/pages/National/Executives/N-Executives2020_2024.tsx
...
const NExecutives2020_2024 = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        // ✅ Filter strictly for 2020–2024 executives
        ...
        console.error("❌ Failed to fetch 2020–2024 executives:", err);
      }
    };
  ...
  return (
    <>
      <NationalNavbar />
      <div style={{ backgroundColor: "#0f4c5c", minHeight: "100vh" }}>
        <PageWithFlagBackground title="🇬🇭 National Executives (2020–2024)">
          <Container className="py-5">
            ...
            {users.length === 0 ? (
              <p className="text-center text-muted">
                No executives recorded for 2020–2024.
              </p>
            ) : (
              <Row className="g-4">
                {users.map((user) => (
...
export default NExecutives2020_2024;
