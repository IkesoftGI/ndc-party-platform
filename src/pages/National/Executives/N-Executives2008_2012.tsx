// src/pages/National/Executives/N-Executives2008_2012.tsx
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        // ✅ Filter strictly for 2008–2012 executives
        ...
        console.error("❌ Failed to fetch 2008–2012 executives:", err);
      }
    };
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#1a365d", minHeight: "100vh" }}>
        <PageWithFlagBackground title="🇬🇭 National Executives (2008–2012)">
          <Container className="py-5">
            ...
            {users.length === 0 ? (
              <p className="text-center text-muted">
                No executives recorded for 2008–2012.
              </p>
            ) : (
              <Row className="g-4">
                {users.map((user) => (
...
export default NExecutives2008_2012;
