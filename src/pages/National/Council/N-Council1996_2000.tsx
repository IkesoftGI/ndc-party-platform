// src/pages/National/Council/N-Council1996_2000.tsx
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        // ✅ Filter for National Council of Elders 1996–2000
        ...
        console.error("❌ Failed to fetch 1996–2000 elders:", err);
      }
    };
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#004225", minHeight: "100vh" }}>
        <PageWithFlagBackground title="🇬🇭 National Council of Elders (1996–2000)">
          <Container className="py-5">
            ...
            {users.length === 0 ? (
              <p className="text-center text-muted">
                No council members recorded yet for 1996–2000.
              </p>
            ) : (
              <Row className="g-4">
                {users.map((user) => (
...
export default NCouncil1996_2000;
