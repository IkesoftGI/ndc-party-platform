// src/pages/National/Council/N-Council2024_2028.tsx
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        // ✅ Filter for National Council of Elders 2024–2028
        ...
        console.error("❌ Failed to fetch 2024–2028 elders:", err);
      }
    };
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#004225", minHeight: "100vh" }}>
        <PageWithFlagBackground title="🇬🇭 National Council of Elders (2024–2028)">
          <Container className="py-5">
            ...
            {users.length === 0 ? (
              <p className="text-center text-muted">
                No council members recorded yet for 2024–2028.
              </p>
            ) : (
              <Row className="g-4">
                {users.map((user) => (
...
export default NCouncil2024_2028;
