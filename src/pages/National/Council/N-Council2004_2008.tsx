// src/pages/National/Council/N-Council2004_2008.tsx
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        // ✅ Filter for National Council of Elders 2004–2008
        ...
        console.error("❌ Failed to fetch 2004–2008 elders:", err);
      }
    };
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#004225", minHeight: "100vh" }}>
        <PageWithFlagBackground title="🇬🇭 National Council of Elders (2004–2008)">
          <Container className="py-5">
            ...
            {users.length === 0 ? (
              <p className="text-center text-muted">
                No council members recorded yet for 2004–2008.
              </p>
            ) : (
              <Row className="g-4">
                {users.map((user) => (
...
export default NCouncil2004_2008;
