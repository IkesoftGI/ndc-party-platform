// src\pages\Regions\Bono\Constituency\BonoConstituencies.tsx
...
const BonoConstituencies: React.FC = () => {
  return (
    <div
    ...
    >
      ...
      <RegionalNavbar region="Bono" />

      {/* Header */}
      <header className="text-center py-5 bg-dark bg-opacity-50">
        <h1 className="fw-bold">🐘 Bono Region Constituencies</h1>
        <p className="lead">
        ...
        <div className="row g-3">
          {[
            ...
            <div key={constituency} className="col-12 col-md-6 col-lg-4">
              <Link
                to={`/regions/bono/constituencies/${constituency
                  .toLowerCase()
                  .replace(/\s+/g, "-")}`}
...
export default BonoConstituencies;
