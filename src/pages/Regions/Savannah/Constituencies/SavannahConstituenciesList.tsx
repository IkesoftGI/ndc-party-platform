// src/pages/Regions/Savannah/Constituencies/SavannahConstituenciesList.tsx
...
const SavannahConstituenciesList: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <RegionalNavbar region="Savannah" />

      {/* Header */}
      <header className="text-center py-5 bg-dark bg-opacity-50">
        <h1 className="fw-bold">🐘 Savannah Region Constituencies</h1>
        <p className="lead">
        ...
        <div className="row g-3">
          {constituencies.map((constituency) => (
            <div key={constituency} className="col-12 col-md-6 col-lg-4">
              <Link
                to={`/regions/savannah/constituencies/${constituency
                  .toLowerCase()
                  .replace(/\s+/g, "-")}`}
...
export default SavannahConstituenciesList;
